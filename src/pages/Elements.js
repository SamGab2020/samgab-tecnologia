			...
			<section id="four" className="wrapper">
				<div className="inner">
					...
					<section>
						...
						<p>Link para a política de privacidade da engine ZXing, utilizada pelo Allcode. ZXing Link para a política de privacidade do Google Play Services, mecanismo também utilizado pelo Allcode. Google Play Services Ajustes para simplificar o Allcode Para simplificar a utilização do Allcode, as permissões originais de acesso aos contatos e também ao armazenamento interno foram removidas, ou seja, o app utiliza somente a permissão da câmera e utilização de rede (internet) para a correta utilização.</p>
						<h4>Segurança</h4>
